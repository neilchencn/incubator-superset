...
class SliceHeader extends React.PureComponent {
  constructor(props) {
    ...
    // this.onSave2Image = this.onSave2Image.bind(this);
  ...
  // onSave2Image() {
  //   const slice_id = this.props.slice.slice_id;
  //   const slice_title = document.querySelector('#slice_' + slice_id + ' input').value;
  //   // const el = document.querySelector('#slice_' + slice_id)
  // .getElementsByClassName('nvd3-svg')[0];
  //   this.props.save2Image(slice_id, slice_title);
  // }

  render() {
    const slice = this.props.slice;
    const isCached = this.props.isCached;
    const cachedWhen = dayjs.utc(this.props.cachedDttm).fromNow();
