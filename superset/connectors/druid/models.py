...
class DruidColumn(Model, BaseColumn):
    ...
    export_fields = (
        'datasource_id', 'column_name', 'verbose_name', 'is_active', 'type', 'groupby',
        'count_distinct', 'sum', 'max', 'min', 'filterable',
...
class DruidDatasource(Model, BaseDatasource):
    ...
    def run_query(  # noqa / druid
        ...
        timezone = from_dttm.replace(
            tzinfo=DRUID_TZ).tzname() if from_dttm else None
